...
group by brand
having count(*) > 10;
-- Se der um alias para o count e tentar usar no having não dá certo, 
-- pois a cláusula HAVING é processada depois do GROUP BY, mas antes do SELECT
-- Por isso, ao invés de usar o alias, você deve referenciar diretamente COUNT(*) na condição HAVING
